...
- [x] 6.6 Implement five-second foreground and thirty-second tray Room API refresh with stale data markers
- [x] 6.7 Implement P2P-preferred and Relay-success presentation using daemon-reported path selection only
- [x] 6.8 Add deterministic state-machine tests for empty rooms, peer appearance, P2P, Relay, outages, reconnect, leave, and conflicting stored state
...
- [x] 8.4 Add adversarial tests with secrets embedded in upstream errors, RPC messages, and log fields
